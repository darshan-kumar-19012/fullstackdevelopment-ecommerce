...
class CreateProductComponent extends Component {
    ...
    render() {
        return (
            <div>
                <br></br>
                   <div className = "container" style={{background:"grey",height:"700px",width:"800px",paddingTop:"40px"}}>
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <div className = "form-group">
                                            <label className='h5'> Product Category : </label>
                                        ...
                                        <div className = "form-group">
                                            <label className='h5'> Product Price: </label>
